                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    ...
                                                    style: TextStyle(
                                                        ...
                                                        Colors.orangeAccent,
                                                        fontSize:
                                                        height / 65,fontWeight: FontWeight.w600),
                                                  ),
                                                ],
                                              ),
                                            ],
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          image: AssetImage("Images/unpaid.jpg")
                                        )
                                      ),
                                      )
                                    ],
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Container(height: height/15,width: 1,
                                        color: Colors.black38,),
                                      ),
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Row(
                                              children: [
                                                Text("Booking Status: "),
                                                Text("Pending",style: TextStyle(color: Colors.orangeAccent,fontWeight: FontWeight.w600),)
                                              ],
                                            ),
                                            Padding(
                                              ...
                                              child: Row(
                                                children: [
                                                  Text("Appointment Id: ",style: TextStyle(color: Colors.black38),),
                                                  Text("CamHed006235",style: TextStyle(color: Colors.black38),),
                                                ],
                                              ),
                                            ),
                                            Padding(
