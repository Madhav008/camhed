...
class NotificationServices {
  ...
  void sendWithdrawRequestNotification() async {
    try {
      var response =
          await Dio().post('https://onesignal.com/api/v1/notifications',
              options: Options(headers: {
            ...
            'app_id': "5d44a640-c2bb-46bc-8ddf-85c9fe35af10",
            'included_segments': ["Admin"],
            'contents': {'en': "New Doctor Withraws Request Is There"},
            'data': {'id': "bar"}
          });
    } catch (e) {
      print(e);
  ...
  void sendDoctorPaymentStatusNotification(String docNotId) async {
    try {
      var response =
          await Dio().post('https://onesignal.com/api/v1/notifications',
              options: Options(headers: {
            ...
            'app_id': "5d44a640-c2bb-46bc-8ddf-85c9fe35af10",
            'include_external_user_ids': [docNotId],
            'contents': {'en': "Check Your Withdraw Request"},
            'data': {'foo': "bar"}
          });
    } catch (e) {
      print(e);
